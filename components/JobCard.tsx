...
export default function JobCard({ vacancy, onSelect, isSelected }: JobCardProps) {
  ...
  return (
    <div
      className={`bg-white rounded-2xl border shadow-sm transition-shadow p-5 flex flex-col gap-4 ${
        isSelected
          ? "border-[#10B981] shadow-md ring-1 ring-[#10B981]/30"
    ...
    >
      ...
      <div className="flex gap-2 mt-auto pt-2 border-t border-[#E5E7EB]">
        ...
        <button
          onClick={onSelect}
          className={`px-4 border text-sm font-medium py-2.5 rounded-xl transition-colors ${
            isSelected
              ? "border-[#10B981] text-[#10B981] bg-[#F0FDF4]"
              : "border-[#E5E7EB] text-[#1F2937] hover:bg-gray-50"
          }`}
        >
          Meer info
        </button>
