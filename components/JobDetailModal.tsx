...
export default function JobDetailModal({ vacancy, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        className="relative bg-white w-full sm:max-w-2xl sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col max-h-[92dvh]"
      ...
      >
        ...
        <div className="p-6 border-b border-[#E5E7EB]">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-lg font-bold text-[#1E2A4A] leading-tight">{vacancy.titel}</h2>
        ...
        <div className="overflow-y-auto flex-1 p-6">
          {activeTab === "omschrijving" && (
            <div className="flex flex-col gap-4">
              ...
              <div>
                <h3 className="text-sm font-semibold text-[#1E2A4A] mb-2">Wat ga je doen?</h3>
              ...
              <div className="flex items-center gap-2 text-xs text-[#6B7280] pt-2 border-t border-[#E5E7EB]">
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Geplaatst {vacancy.geplaatst}
              </div>
            </div>
          )}
        ...
        <div className="p-4 border-t border-[#E5E7EB] flex gap-3">
          <button className="flex-1 bg-[#10B981] hover:bg-[#059669] text-white text-sm font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-1.5">
          ...
          <button
            onClick={onClose}
            className="px-5 border border-[#E5E7EB] text-[#1F2937] text-sm font-medium py-3 rounded-xl hover:bg-gray-50 transition-colors"
          >
            Sluiten
          </button>
        </div>
